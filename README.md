...
8. В админпанели стандартным способом обновите плагин *Git Updater*. После этого будут доступны автоматические обновления плагина *True Image & True Sizes* (и любых других плагинов с GitHub). В зависимости от особенностей вашего хостинга обновления могут стать доступны через 1-10 минут. Проверьте также оп-цию "Включить автоматические обновления" напротив каждого плагина на странице Плагины > Установленные.
